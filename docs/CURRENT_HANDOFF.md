...
**Feature efforts still on the board — Jon picks; do not infer** (the live dispatch target is ferry Dispatch 1.5 at the top of this section, and nothing else):
...
- **This does NOT jump the ferry queue.** [`efforts/dogfood-ferry-2026-07-25.md`](efforts/dogfood-ferry-2026-07-25.md) still runs **1.5 → 2 → 3**, and Dispatches 2 and 3 are both unstarted. This effort shares no files with either (2 is hand-off controls, 3 is workbench lifecycle) and competes only with [ADR-0046](decisions/ADR-0046-sidebar-adaptable-app-shell.md).
