...
- [ADR-0012](ADR-0012-menu-actionable-chat.md) — Menu actionable chat: extends ADR-0011 to a composite subject (a whole menu); staged prep plan on `Menu` + advisory verbs; `Menu` scope first, planner-day later (Proposed — SKELETON, design session pending)
