...
public struct RecipeChatRecipeContext: Equatable, Sendable {
  ...
  public init(detail: RecipeDetailData) throws {
    ...
    self.init(
      ...
      serveWith: try ServeWithCoding.decode(detail.recipe.serveWith, recipeID: detail.recipe.id),
...
public final class RecipeChatModel: Identifiable {
  ...
  public func send(_ text: String) async -> Bool {
    ...
    guard !trimmed.isEmpty, !isResponding, responseTask == nil else { return false }
